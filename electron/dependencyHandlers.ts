    ...
    createIpcHandler(
      ...
      async () => {
        ...
        return {
          ...
          amdGpuAvailable: caps.amdGpuAvailable,
          intelGpuAvailable: caps.intelGpuAvailable,
          rocmRuntimeAvailable: caps.rocmRuntimeAvailable,
          ...
          diagnostics: {
            ...
            onnxRuntimeVersion: caps.onnxRuntimeVersion,
            onnxPluginPath: caps.onnxPluginPath,
            onnxBuildInfo: caps.onnxBuildInfo,
            nvidiaGpuName: caps.nvidiaGpuName,
            nvidiaCudaVersion: caps.nvidiaCudaVersion,
